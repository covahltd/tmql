...
const publishedPostsListPipeline = new TMPipeline<BlogPostSchema>()
...
const postWithCommentsPipeline = new TMPipeline<BlogPostSchema>()
  // Match specific post
  .match({
    status: "published",
...
const contentAnalyticsPipeline = new TMPipeline<BlogPostSchema>()
...
const authorPerformancePipeline = new TMPipeline<BlogPostSchema>()
  // Filter published posts
  .match({
    status: "published",
  })
...
const contentSearchPipeline = new TMPipeline<BlogPostSchema>()
