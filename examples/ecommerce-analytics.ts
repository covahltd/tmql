...
const salesByCategoryPipeline = new TMPipeline<OrderSchema>()
...
const customerPurchaseAnalysisPipeline = new TMPipeline<OrderSchema>()
...
const productPerformancePipeline = new TMPipeline<OrderSchema>()
...
const geographicSalesPipeline = new TMPipeline<OrderSchema>()
  // Filter delivered orders
  .match({
    status: "delivered",
  })
