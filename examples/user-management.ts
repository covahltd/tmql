...
const publicUserProfilePipeline = new TMPipeline<UserSchema>()
...
const userListWithActivityPipeline = new TMPipeline<UserSchema>()
  // Filter active users
  .match({
    "metadata.isActive": true,
  })
...
const adminUserManagementPipeline = new TMPipeline<UserSchema>()
...
const userActivityAnalysisPipeline = new TMPipeline<ActivitySchema>()
...
const cleanUserDataPipeline = new TMPipeline<UserSchema>()
