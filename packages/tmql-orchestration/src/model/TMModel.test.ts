...
describe("TMModel", () => {
  ...
  describe("Pipeline Generation", () => {
    ...
    it("should build $merge for Append mode", () => {
      const appendModel = new TMModel({
        name: "append_only",
        from: RawEventsCollection,
        pipeline: (p) => p,
        materialize: { type: "collection", mode: TMModel.Mode.Append },
      });
